...
import (
	...
	"github.com/codebasetwo/greenlight/internal/validator"
	"github.com/lib/pq"
)
...
type Movie struct {
	...
	CreatedAt time.Time `json:"-"`              // Timestamp for when the movie is added to our database, - omit from json output
	Title     string    `json:"title"`          // Movie title
	Year      int32     `json:"year,omitempty"` // Movie release year,  omitempty omit if empty
